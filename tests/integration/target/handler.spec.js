...
describe('./tests/integration/target/handler.js', () => {
  describe('#handler', () => {
    const eventHandlerAsync = (impl) => (event, context) => new Promise((resolve, reject) => {
  ...
  describe('#handlerResponse', () => {
    it('should create a success message', () => assert.deepStrictEqual(
  ...
  describe('#handlerError', () => {
    it('should create and log a failure message', () => assert.deepStrictEqual(
  ...
  describe('#test', () => {
    it('should return handler response on success', () => handler({
      recordRequest: (id) => assert(id, testId, 'correct test id is recorded'),
    }).test({ pathParameters: { id: testId } }, {}, () => {})
    )

    it('should return handler error on fail', () => handler({
  ...
  describe('#list', () => {
    ...
    it('uses start time from parameters, if provided', () => handler({
    ...
    it('uses end time from parameters, if provided', () => handler({
    ...
    it('uses both start and end time from parameters, if provided', () => handler({
